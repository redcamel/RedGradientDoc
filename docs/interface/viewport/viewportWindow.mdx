...
- #### 개별 Viewport Window의 view 상태를 설정합니다.
  ...
  - Container Background Color : 편집중인 Container의 배경색을 설정합니다.
...
## Snap to container
- 그라디언트 사이즈 & 위치 변경시 container의 경계에 snap 시킬지 여부를 설정합니다.
- TODO snap 동영상 추가
